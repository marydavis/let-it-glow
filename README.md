...
### Let's make sure it works
  ...
  1. Your board should have a green light on it.
  ...
  1. You should see it sending information in the console at the bottom of the screen.
  1. Now you should see an orange light on your board flashing every 1 second. 
